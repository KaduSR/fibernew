  ...
  return (
    ...
    >
      <div className="flex flex-col gap-y-10 2lg:container 2lg:mx-auto 2lg:flex-row 2lg:justify-end 2lg:gap-x-[4.375rem]">
        {/* Texto e CTA */}
        <div className="flex flex-col px-5 md:mx-auto md:flex md:w-[42.5rem] md:px-6 2lg:w-[29.25rem] 2lg:p-0">
        ...
        <div className="relative px-5 md:mx-auto md:max-w-[39.375rem] md:px-0">
          <div className="grid grid-cols-1 grid-rows-3 gap-y-2 md:grid-cols-3 md:grid-rows-1 md:gap-x-1">
            {/* Card 1 */}
          ...
          {/* Botões de seta (se quiser manter) */}
          <div className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 space-x-4">
            <ArrowRightIcon className="h-6 w-6 text-orange-400 dark:text-white rotate-180 cursor-pointer" />
            <ArrowRightIcon className="h-6 w-6 text-orange-400 dark:text-white cursor-pointer" />
          </div>
