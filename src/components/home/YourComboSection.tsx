...
export default function YourComboSection() {
  return (
    <section
      id="your-combo"
      className="bg-white 700 md:pb-24 md:pt-20 lg:pt-24 pb-20 pt-[5.5rem]"
    >
      <div className="flex flex-col gap-y-10 2lg:container 2lg:mx-auto 2lg:flex-row 2lg:justify-end 2lg:gap-x-[4.375rem]">
        {/* Grid de ofertas */}
        <div className="flex-col px-5 md:mx-auto md:max-w-[42.5rem] md:px-6 2lg:w-[29.25rem] 2lg:p-0">
          <h2 className="mb-2 font-figtree text-[2rem] font-bold leading-9 text-black md:m-auto md:mb-8 mb:text-center md:text-[2.5rem] md:leading-[.75rem] 2lg-[29.25rem] 2lg:text-left">
            Aproveite nossos serviços e{" "}
            <span className="relative">
              promoções
              <span className="absolute botom-[6px] left-0 h-1 w-full roundoed-sm bg-orange-500"></span>
            </span>
          </h2>
          {/* Card 1 */}
          <div className="focus-visible:ring-ring items-center justify-center rounded-lg text-lg ring-offset-background transition-colors focus:ring-orange-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-background-dark dark:focus:ring-yellow-200 border-none bg-background dark:bg-background-dark font-semibold text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 h-[180px] w-full pr-4 flex md:mt-[2.6875rem] md:h-[21.875rem] md:w-[12.75rem] md:flex-col md:gap-6 md:pr-0">
            <div className="relative px-5 md:m-auto md:max-[39.375rem] md:px-0">
          ...
          <div className="relative flex h-[180px] w-full items-center gap-4 rounded-[1.25rem] bg-background pr-4 dark:bg-background-dark md:mt-[2.6875rem] md:h-[21.875rem] md:w-[12.75rem] md:flex-col md:gap-6 md:pr-0">
            ...
            <div className="relative md:bottom-[2.6875rem] md:w-[9.5625rem]">
              ...
              <div className="mb-3 mt-2 h-0.5 w-9 rounded-md bg-orange-400 dark:bg-white" />
              <p className="font-barlow text-xs font-normal text-gray-600 dark:text-white">
                Serviços de streaming de filmes, canais ao vivo, músicas e mais.
              </p>
            </div>
          </div>
          {/* Card 3 */}
        ...
        {/* Texto e CTA 
          <div className="flex flex-col px-5 md:mx-auto md:flex md:w-[42.5rem] md:px-6 2lg:w-[29.25rem] 2lg:p-0 justify-end">
