...
export function StatsSection() {
  return (
    <section className="bg-white py-12 md:py-16 dark:bg-black items-center">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center items-center">
          ...
          <div className="flex flex-col items-center md:items-center justify-start ">
            ...
            <p className="mt-2 text-sm md:text-base text-gray-600 text-center dark:text-white md:text-left">
          ...
          <div className="flex flex-col items-center md:items-center">
            ...
            <p className="mt-2 text-sm md:text-base text-gray-600 text-center md:text-left dark:text-white">
