    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[425px] md:max-w-[738px] xl:max-w-[1166px] p-0">
                <button onClick={onClose} className="absolute right-6 top-6 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none">
                    <X className="h-5 w-5" />
                ...
                <div className="p-6 md:p-8 xl:p-16">
                    <div className="mx-auto flex flex-col items-center justify-center md:flex-row-reverse md:items-start">
                        ...
                        <div className="mt-6 flex flex-col md:mt-0">
                            ...
                            <form onSubmit={handleCitySubmit} className="mt-6 "></form>
                        </div>
                    </div>
                </div>
    )
