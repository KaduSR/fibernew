    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] md:max-w-[738px] xl:max-w-[1166px] p-0">
        ...
        <div className="p-6 md:p-8 xl:p-16">
          <div className="mx-auto flex flex-col items-center justify-center md:flex-row-reverse md:items-start">
            {/* Map ilustration*/}
            <div className="relative md:ml-20 xl:ml-32">
              <div className="relative h-40 w-48 md:h-[13.35rem] md:w-[16.37rem] xl:h-[17.36rem] xl:w-[21.29rem]">
                <Image
                  ...
                  alt="Mapa do Brasil com destaques para as cidades atendidas"
                  width={340}
                  height={277}
                  className="h-full w-full object-contain"
                  priority
                />
                {/*  Animated pin markers would br added here in a production site*/}
              </div>
            </div>
            {/* Form content */}
              ...
              >
                <div className="relative">
                  <div className="relative group flex items-center rounded-lg border px-3 focus-within:border-primary">
                    ...
                    <Label
                      htmlFor="city-input"
                      className="pointer-events-none absolute left-3 top-0 -translate-y-1/2 transform bg-white px-1 text-xs text-gray-500 transition-all peer-focus:-top-0 peer-focus:text-xs peer-focus:text-primary"
                    >
                      Digite sua cidade
                    </Label>
                  </div>
